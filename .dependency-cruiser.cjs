...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: { path: "^(packages/(core|sync|transforms|ui|figma-bridge|ai)|apps)" },
    },
    {
      name: "core-only-schema",
      severity: "error",
      from: { path: "^packages/core" },
      to: { path: "^(packages/(sync|transforms|ui|figma-bridge|ai)|apps)" },
    },
    {
      name: "sync-only-core-schema",
      severity: "error",
      from: { path: "^packages/sync" },
      to: { path: "^(packages/(transforms|ui|figma-bridge|ai)|apps)" },
    },
    {
      name: "ai-only-core-schema",
      severity: "error",
    ...
    },
    {
      ...
      to: { path: "^(packages/(sync|ui|figma-bridge|ai)|apps)" },
    },
    {
      name: "figma-bridge-only-core-schema",
      severity: "error",
      from: { path: "^packages/figma-bridge" },
      to: { path: "^(packages/(sync|transforms|ui|ai)|apps)" },
    },
    {
      name: "ui-only-core-schema",
      severity: "error",
      from: { path: "^packages/ui" },
      to: { path: "^(packages/(sync|transforms|figma-bridge|ai)|apps)" },
    },
    {
